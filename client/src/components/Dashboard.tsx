...
const weightProgressData = [
  { week: 'Week 1', weight: 165, target: 155, bodyFat: 28 },
  { week: 'Week 2', weight: 163, target: 155, bodyFat: 27.5 },
  { week: 'Week 3', weight: 161, target: 155, bodyFat: 27 },
  { week: 'Week 4', weight: 159, target: 155, bodyFat: 26.5 },
  { week: 'Week 5', weight: 158, target: 155, bodyFat: 26 },
  { week: 'Week 6', weight: 156, target: 155, bodyFat: 25.5 },
  { week: 'Week 7', weight: 155, target: 155, bodyFat: 25 },
  { week: 'Week 8', weight: 154, target: 155, bodyFat: 24 },
];
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
              ...
              <Card className="lg:col-span-2">
                ...
                <CardContent className="space-y-4">
                  {dashboardData?.upcomingWorkouts?.length > 0 ? (
                    dashboardData.upcomingWorkouts.slice(0, 5).map((workout: any) => (
                      <div key={workout._id} className="border rounded-lg p-4 hover:bg-orange-50 transition-colors">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h4 className="text-sm font-medium text-gray-900">{workout.title}</h4>
                              <p className="text-xs text-gray-500">{new Date(workout.date).toLocaleDateString('en-US', { weekday: 'long', month: 'short', day: 'numeric' })}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm text-gray-600 bg-gray-50 rounded p-3 border border-gray-200">
                          {workout.type} - {workout.description || 'Great workout session!'}
                        </p>
                      </div>
                    ))
                  ) : (
                    <p className="text-gray-500 text-center py-4">No recent workouts recorded.</p>
                  )}
                </CardContent>
              </Card>
          ...
          <TabsContent value="team" className="space-y-6 mt-6">
            <div className="grid lg:grid-cols-2 gap-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-gray-900 mb-1">{dashboardData.trainer.name}</h3>
                        <p className="text-sm text-gray-600 mb-2">{dashboardData.trainer.specializations?.[0] || 'Personal Trainer'}</p>
                        <div className="flex items-center gap-2 mb-2">
                          <div className="flex items-center gap-1">
                            {[...Array(5)].map((_, i) => (
                              <Star key={i} className={`h-4 w-4 ${i < 5 ? 'fill-orange-600 text-orange-600' : 'text-gray-300'}`} />
                            ))}
                          </div>
                    ...
                    <div className="space-y-3 mb-6">
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        ...
                        <span className="text-sm font-medium text-gray-900">1456</span>
                      </div>
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex gap-2 mt-6">
                      ...
                      <Button
                        ...
                        className="flex-1"
                        onClick={() => {
                          setChatRecipient({ id: dashboardData.trainer._id, name: dashboardData.trainer.name });
                          setIsChatOpen(true);
                        }}
                      >
              ...
              {dashboardData?.gym ? (
                <Card>
                  ...
                  <CardContent>
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">{dashboardData.gym.gymName}</h3>
                    <p className="text-sm text-gray-600 mb-3 flex items-center gap-1">
                      <MapPin className="h-4 w-4" />
                      {dashboardData.gym.gymLocation}
                    </p>
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-sm text-gray-600">287 members</span>
                    </div>
                    <div className="space-y-3 mb-6">
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <span className="text-sm text-gray-600">Monthly Price</span>
                        <span className="text-sm font-medium text-gray-900">$199</span>
                      </div>
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <span className="text-sm text-gray-600">Opening Hours</span>
                        <span className="text-sm font-medium text-gray-900">5:00 AM - 11:00 PM</span>
                      </div>
                    </div>
                    <div className="space-y-2 mb-6">
                      <p className="text-sm font-medium text-gray-900 mb-2">Amenities:</p>
                      <div className="flex flex-wrap gap-2">
                        {dashboardData.gym.facilities?.slice(0, 5).map((facility: string, index: number) => (
              ...
              {!dashboardData?.trainer && !dashboardData?.gym && (
                <Card className="lg:col-span-2">
